...
namespace UAParserSharp
{
  public class UserAgentStringInfo
  {
    ...
    { get { return ua_family; } }
    public string UAName
    { get { return ua_name; } }
    public string UAUrl
    { get { return ua_url; } }
    public string UACompany
    { get { return ua_company; } }
    public string UACompanyUrl
    { get { return ua_company_url; } }
    public string UAIcon
    { get { return (new Uri (UASParser.UAImagesURL, ua_icon)).ToString(); } }
    public string UAInfoUrl
    { get { return (new Uri (UASParser.UserAgentStringURL,ua_info_url)).AbsoluteUri; } }
    ...
    public string OSUrl
    { get { return os_url; } }
    public string OSCompany
    { get { return os_company; } }
    public string OSCompanyUrl
    { get { return os_company_url; } }
    public string OSIcon
    { get { return (new Uri (UASParser.OSImagesURL, os_icon)).ToString(); } }
